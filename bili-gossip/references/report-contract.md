...
```json
{
  "event": {
    ...
    "summary": "以B站百大UP主@吃瓜bot口吻写的开场白，不超过200字，标题党语气，说清5W，省略号只用一次打在读者最想往下看的地方"
  },
  "timeline": [
    {
      "date": "2026-06-01",
  ...
  "lesson_videos": [],
  "install_command": "npx skills add https://github.com/jiubanszd/bili-gossip-skill/tree/main/bili-gossip -g -y"
}
```
